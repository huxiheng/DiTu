...
- (void)awakeFromNib {
    ...
    _imageviewProjectADDLine.frame =CGRectMake(0, kscaleDeviceHeight(39), DeviceWidth, kscaleDeviceHeight(1));
...
- (void)setData:(NSDictionary *)data{
    ...
    _cellProjectNameLabel.text =[NSString stringWithFormat:@"项目名称：%@", data[@"ProjectName"]] ;
    ...
    _cellProjectAddressLabel.text = [NSString stringWithFormat:@"项目地址：%@", data[@"ProjectAddress"]] ;
